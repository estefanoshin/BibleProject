#!/usr/bin/env python3
"""Fetch Reina Valera Actualizada (RVA-2015) from Bible Gateway and write CSVs."""
...
def fetch_html(book_en: str, chapter: int) -> str:
    ...
    key = f"{book_en.replace(' ', '_')}_{chapter}.html"
...
def main() -> int:
    ...
    total = len(plan)
    print(f"Fetching {total} RVA-2015 chapters from Bible Gateway")
